(function ($, $n2) {
    ...
    function getColors() {
        return [
            ...
            '#FFDB66', '#006401', '#2E2BE0', '#95003A', '#007DB5',
            '#FF00F6', '#892BD6', '#774D00', '#90FB92', '#0076FF',
            '#D5FF00', '#FF937E', '#6A826C', '#FF029D', '#FE8900',
            '#7A4782', '#7E2DD2', '#85A900', '#FF0056', '#A42400',
            '#00AE7E', '#EB3D34', '#7083FA', '#F7F736', '#DE6102',
            '#00B917', '#9E008E', '#2165FC', '#C28C9F', '#7DDB8D',
            '#01D0FF', '#6AC404', '#E56FFE', '#788231', '#0E4CA1',
            '#3DD4C7', '#BE9970', '#968AE8', '#BB8800', '#850056',
            '#DEFF74', '#FC9FDC', '#FFE502', '#821300', '#008F9C',
            '#98FF52', '#7544B1', '#FF00B3', '#00FF78', '#FF6E41',
            '#005F39', '#B500FF', '#5FAD4E', '#A75740', '#A5FFD2',
        ];
    }
