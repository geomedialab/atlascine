(function ($, $n2) {
    ...
    function updateDocInfo(docInfo, doc) {
        ...
        if (oldDonutsId && Array.isArray(oldDonutsId) && oldDonutsId.length > 0) {
        ...
        if (doc._n2CineIndex && Array.isArray(doc._n2CineIndex) && doc._n2CineIndex.length > 0) {
            docInfo.linkingDonutsId = [];
        }
        return docInfo;
    }

    var ThemeData2DonutTransform = $n2.Class('ThemeData2DonutTransform', {
        ...
        _handle: function (m) {
            ...
            if ('modelGetInfo' === m.type) {
                ...
                docId = m.docId;
                if (docId && this.startTimeByDocId) {
        ...
        _populateDocInfosFromDoc: function (doc) {
            ...
            if (cineIndexArr && cineIndexArr.length >= 1) {
                for (var cidx of cineIndexArr) {
                    ...
                    donutDocInfo.doc._storyTitle = cidx.title,
                        ...
                        donutDocInfo.doc._color = cidx.color;
    ...
    Object.assign($n2.atlascine, {
        ThemeData2DonutTransform: ThemeData2DonutTransform
    });
