; (function ($, $n2) {
    ...
    var CinemaSelectionRedirector = $n2.Class('CinemaSelectionRedirector', {
        ...
        _handleUserSelect: function (m, addr, dispatcher) {
            ...
            if (undefined !== startTime) {
                if (m.doc && m.doc._storyId) {
                    this.dispatchService.send('atlascine', {
                        type: 'changeCineViaDonut',
                        name: this.name,
                        docId: m.doc._storyId,
                        color: m.doc._color,
                ...
                this.dispatchService.send(DH, { type: 'unselected' });
            } else {
